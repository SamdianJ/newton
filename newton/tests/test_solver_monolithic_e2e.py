...
class TestNormalLoadingContract(unittest.TestCase):
    def test_drive_and_versioned_status_contract(self):
        ...
        self.assertEqual(fixture["calibration_status"], "FROZEN")
        self.assertEqual(fixture["support_status"], "FROZEN")
...
def test_short_normal_loading(test, device):
    ...
    test.assertEqual(result["metadata"]["support_status"], "FROZEN")
